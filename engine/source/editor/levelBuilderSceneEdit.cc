...
bool LevelBuilderSceneEdit::onMouseEvent(LevelBuilderSceneWindow* sceneWindow, const EditMouseStatus& mouseStatus)
{
   ...
   case EditMouseStatus::TYPE_WHEEL_DOWN:
      ...
      break;
   case EditMouseStatus::TYPE_NONE:
   case EditMouseStatus::TYPE_RIGHT_MOVE:
   case EditMouseStatus::TYPE_MIDDLE_MOVE:
   {
      Con::errorf("Unhandled case in LevelBuilderSceneEdit::onMouseEvent");
      break;
   }
   }
