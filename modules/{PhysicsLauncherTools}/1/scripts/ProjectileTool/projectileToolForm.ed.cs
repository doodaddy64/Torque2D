...
/// </summary>
function ProjectileToolForm::selectSound(%this)
{
...
function Pt_PreviewSelectDropdown::onSelect(%this)
{
    ...
    ProjectileToolForm.selectedSound = %index;
    ProjectileToolForm.selectSound();
    alxStop(%this.sound);
    if (ProjectileToolForm.soundName !$= "")
        %this.sound = alxPlay(ProjectileToolForm.soundName);
...
{
    PhysicsLauncherTools::audioButtonPairStart(%this, ProjectileToolForm.soundName);
}
