if (!isObject(GuiColorPickerTextEditProfile)) new GuiControlProfile (GuiColorPickerTextEditProfile)
{
    Name = "GuiColorPickerTextEditProfile";
    tab = "0";
    canKeyFocus = "1";
    mouseOverSelected = "0";
    Modal = "1";
...
if (!isObject(GuiColorPickerPreviewProfile)) new GuiControlProfile (GuiColorPickerPreviewProfile)
{
    tab = "0";
    canKeyFocus = "0";
    mouseOverSelected = "0";
