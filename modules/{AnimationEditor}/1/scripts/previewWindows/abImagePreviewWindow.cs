...
/// @class ABImagePreviewWindow
/// This class must be derived from ImagePreviewWindow. It provides drag and
/// drop functionality for the animation builder.

/// void(ABImagePreviewWindow this)
...
function ABImagePreviewWindow::onAdd(%this)
{
   Assert(%this.superclass $= "ImagePreviewWindow",
             "ABImagePreviewWindow::onAdd - This class is designed to subclass ImagePreviewWindow!");
   
   Parent::onAdd(%this);
   %this.spriteClass = "ABImagePreviewSprite";
}

/// void(ABImagePreviewSprite this, ModifierKey modifier, Point2F position, int clicks)
...
function ABImagePreviewSprite::onTouchDown(%this, %modifier, %position, %clicks)
{
   if (%clicks == 2)
...
function ABImagePreviewSprite::onTouchDragged(%this, %modifier, %position, %clicks)
{
