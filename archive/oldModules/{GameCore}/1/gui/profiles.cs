...
if(!isObject(GuiDefaultProfile)) new GuiControlProfile (GuiDefaultProfile)
{
   ...
   // bitmap information
   bitmap = "^{GameCore}/gui/images/window.png";
   bitmapBase = "";
   textOffset = "0 0";
...
if(!isObject(GuiTextWhite24Profile)) new GuiControlProfile (GuiTextWhite24Profile)
{
    fontType = "Tahoma Bold";
    fontSize = 24;
    fontColor = "255 255 255";
...
if(!isObject(GuiTextWhite48Profile)) new GuiControlProfile (GuiTextWhite48Profile)
{
    fontType = "Tahoma Bold";
    fontSize = 48;
    fontColor = "255 255 255";
...
if(!isObject(GuiTextCenteredProfile)) new GuiControlProfile (GuiTextCenteredProfile)
{
    fontType = "Tahoma Bold";
    fontSize = 14;
    fontColor = "0 0 0";
