...
{
    %this.setActiveTool($CollisionEditor::SelectionToolIndex);
    
    CESelectButton.NormalImage = "{3SSCollisionEditor}:largeSelectionDepressedImage";
    CESelectButton.HoverImage = "{3SSCollisionEditor}:largeSelectionDepressedImage";
