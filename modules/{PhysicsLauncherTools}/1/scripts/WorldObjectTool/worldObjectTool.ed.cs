...
function WorldObjectTool::selectObject(%this, %data)
{
    ...
    WorldObjectTool.lastSelectedObject = %object;  

    %this.refresh();
    %this.SetSelectedObjectButton(getWord(%data, 1));
    //$WorldObjectToolObjectScrollView.scrollToButton(getWord(%data, 1));
}
...
function Wot_SoundPlayButton::onClick(%this)
{
    ...
    %soundAsset = WorldObjectBuilder::getSoundForState(%currentObject, %selectedState);
    PhysicsLauncherTools::audioButtonClicked(%this, %soundAsset);
}
