...
IMPLEMENT_GLOBAL_LIST(PBXRezBuildPhase)
...
IMPLEMENT_WRITE_GLOBAL_LIST(PBXRezBuildPhase)
{
    stream << endl << "/* Begin PBXRezBuildPhase section */" << endl;
    U32 size = m_List.size();
    for(U32 i=0; i<size; ++i)
    {
        PBXRezBuildPhase* phase = m_List[i];
    ...
    stream << "/* End PBXRezBuildPhase section */" << endl;
