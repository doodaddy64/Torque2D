//--- OBJECT WRITE BEGIN ---
new GuiControlProfile(GuiGameMLTextCenteredSmProfile) {
   tab = "0";
   canKeyFocus = "0";
   mouseOverSelected = "0";
   Modal = "1";
   ...
   bevelColorHL = "1 0 0 0";
   bevelColorLL = "2 0 0 0";
   fontType = "SF Cartoonist Hand";
   fontSize = "24";
   fontCharset = "ANSI";
   fontColors = "254 254 254 255";
	fontColor = "27 59 95 255";
	fontColorHL = "232 240 248 255";
	fontColorNA = "0 0 0 52";
	fontColorSEL= "10 10 10 255";
   fontColorLink = "27 0 0 27";
   fontColorLinkHL = "160 110 13 0";
   justify = "center";
   textOffset = "0 0";
   autoSizeWidth = "0";
   autoSizeHeight = "0";
